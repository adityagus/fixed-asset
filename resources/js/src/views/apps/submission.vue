    ...
    <div class="flex items-center justify-between flex-wrap gap-4 px-4 py-2">
      <div class="">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
          class="dark:invert cursor-pointer transition-transform duration-500" :class="{ 'animate-spin': isRefreshing }"
          @click="refreshData">
        ...
        <div class="mt-3 flex flex-wrap border-b border-white-light dark:border-[#191e3a]">
          ...
          <button :class="[
            ...
            store.activeTab === 'purchase-request'
              ...
              : ''
          ]" @click="store.tabSubmission('purchase-request')" type="button">
            <!-- Icon: Clipboard List -->
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
          ...
          <button v-if="store.user?.idgrup == 'JBT-018'" :class="[
            'flex items-center border-transparent px-5 py-3 gap-2 hover:border-b hover:!border-primary hover:text-primary -mb-[1px]',
            store.activeTab === 'purchase-order'
              ? 'border-b !border-primary text-primary !outline-none'
              : ''
          ]" @click="store.tabSubmission('purchase-order')" type="button">
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
              ...
              <polyline points="11 15 14 21 24 7" stroke="#22c55e" stroke-width="3" fill="none" stroke-linecap="round"
          ...
          <button v-if="store.user?.idgrup == 'JBT-018'" :class="[
            ...
            store.activeTab === 'registration-asset'
              ? 'border-b !border-primary text-primary !outline-none'
              : ''
          ]" @click="store.tabSubmission('registration-asset')" type="button">
            <!-- Icon: Tag -->
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 ltr:mr-2 rtl:ml-2">
              <path d="M3 11V7a4 4 0 0 1 4-4h4a2 2 0 0 1 1.414.586l7 7a2 2 0 0 1 0 2.828l-7 7a2 2 0 0 1-2.828 0l-7-7A2 2 0 0 1 3 11Z"
                    ...
                    <td class="flex justify-center">
                      <template v-if="pr.status === 'Draft'" class="text-center">
                        ...
                        <svg width='24' height='24' xmlns="http://www.w3.org/2000/svg"
                          @click="handleDeleteSubmission('purchase-request', pr.pr_number)" fill="none" viewBox="0 0 24 24"
                          stroke-width="1.5" class="size-6 cursor-pointer hover:stroke-red-400 stroke-red-500 rounded">
                  ...
                  <tr v-for="po in filteredOrders" :key="po.id">
                    ...
                    <td class="flex justify-center">
                      <template v-if="po.status === 'Draft'">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                          @click="handleDeleteSubmission('purchase-order', po.po_number)" xmlns="http://www.w3.org/2000/svg"
                          stroke-width="1.5" class="size-6 cursor-pointer hover:stroke-red-400 stroke-red-500 rounded">
                          <path stroke-linecap="round" stroke-linejoin="round"
                            d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                        </svg>
