...
const routes: RouteRecordRaw[] = [
    ...
    // approval
    {
        ...
        name: "approval-all",
        component: () => import(/* webpackChunkName: "apps-all-approval" */ "../views/approvals/all-approval.vue"),
    },
    {
        path: "/approval/po-approval",
        name: "po-approval",
        component: () => import(/* webpackChunkName: "apps-po-approval" */ "../views/approvals/po-approval.vue"),
    },
    {
        path: "/approval/pr-approval",
        name: "pr-approval",
    ...
    {
        path: "/report/barcodes",
        name: "report-barcodes",
        component: () => import(/* webpackChunkName: "report-barcodes" */ "../views/report/report-barcode.vue"),
    },
    {
...
router.beforeEach((to, from, next) => {
    ...
    if (!appStore.isLoggedIn && to.name !== "boxed-signin") {
        // redirect ke login jika belum login (cek token, bukan user)
        appStore.$dispose();
