...
Route::middleware('jwt')->group(function () {
  ...
  Route::prefix('master/')->group(function () {
    ...
    // MASTER APPROVAL
    Route::get('approval', [MasterController::class, 'getMstApproval']);
    Route::get('approval/{id}', [MasterController::class, 'getMstApprovalById']);
    Route::post('approval', [MasterController::class, 'createMstApproval']);
    Route::put('approval/{id}', [MasterController::class, 'updateMstApproval']);
    Route::delete('approval/{id}', [MasterController::class, 'deleteMstApproval']);
